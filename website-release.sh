...
RELEASE_FILE_DIRECTORY_NAME="./_data/projects/${PROJECT}/releases/${RELEASE_VERSION_FAMILY}"
mkdir -p "$RELEASE_FILE_DIRECTORY_NAME"
RELEASE_FILE_NAME="${RELEASE_FILE_DIRECTORY_NAME}/${RELEASE_VERSION}.yml"
